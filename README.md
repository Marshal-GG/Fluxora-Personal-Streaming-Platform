...
|-----------|--------|-------|
| FastAPI server | ✅ Done | 134 tests; all routers + services; migrations 001–010; hardware encoding; orders/logs/healthz endpoints; live system stats; conditional Sentry init; `remote_url` on /info |
