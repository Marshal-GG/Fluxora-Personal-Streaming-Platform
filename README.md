...
|-----------|--------|-------|
| FastAPI server | ✅ Done | 128 tests; all routers + services; migrations 001–010; hardware encoding; orders/logs endpoints; live system stats; conditional Sentry init |
