...
> **Category:** Planning  
> **Status:** Active - Updated 2026-04-29 (Phase 4 payment decisions resolved)
...
| Q-009 | How do we prevent license key sharing or theft? Should we bind keys to a unique Server ID or require a one-time cloud activation in the future? | High | ❌ |
