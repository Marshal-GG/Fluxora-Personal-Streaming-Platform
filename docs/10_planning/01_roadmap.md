...
> **Category:** Planning  
> **Status:** Active - Updated 2026-05-03 (Phase 5 in progress; M0 backend fully complete: 253 tests; desktop redesign M1–M10 shipped — including M10 custom window chrome / FluxTitlebar / Aero Peek shell-integration; **mobile redesign M0–M9 landed** — Discover surfaces / Detail / Episodes / Player chrome + gestures + sheets / Mini-player + drag-down minimize / Downloads + Profile + Notifications real-data wiring / V2 theme cutover. Next mobile milestone: M10 X-Ray + Group Watch + Offline state shells.)
