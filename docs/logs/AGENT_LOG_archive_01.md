...
## [2026-04-27] — Document Known Risks
**Agent:** Antigravity
**Phase:** Phase 1 — Setup
**Status:** Complete

### What Was Done
- Updated `CLAUDE.md` to document the bash commit backtick pathspec issue and the pytest exit code 5 collection issue in the "Known Risks & Gotchas" table.
...
| Doc File | What Changed |
|----------|-------------|
| `CLAUDE.md` | Added bash commit and pytest risks to the "Known Risks & Gotchas" section. |
...
## [2026-04-27] — Document Git Pull Branch Issue
**Agent:** Antigravity
**Phase:** Phase 1 — Setup
**Status:** Complete

### What Was Done
- Updated `CLAUDE.md` to document the unwanted "Merge branch 'main'" commit issue when running `git pull` with diverged branches in the "Known Risks & Gotchas" table.
...
| Doc File | What Changed |
|----------|-------------|
| `CLAUDE.md` | Added Git pull/merge risk to the "Known Risks & Gotchas" section. |

### Decisions Made
- Instructed to always use `git pull --rebase` to prevent automated merge commits from polluting the git history.
