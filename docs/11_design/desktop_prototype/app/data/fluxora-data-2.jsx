...
window.FluxData2 = {
  ...
  movies: [
    { title:"Inception",        year:2010, runtime:"2h 28m", rating:8.8, qual:"1080p HDR", art:"linear-gradient(135deg, #1a0f2e, #6b3aa6)" },
    { title:"Interstellar",     year:2014, runtime:"2h 49m", rating:8.7, qual:"4K HDR",    art:"linear-gradient(180deg, #050810, #2a3a6a)" },
    { title:"The Batman",       year:2022, runtime:"2h 56m", rating:7.8, qual:"720p",      art:"linear-gradient(160deg, #050508, #3a1422)" },
    { title:"Dune: Part Two",   year:2024, runtime:"2h 46m", rating:8.6, qual:"4K HDR",    art:"linear-gradient(135deg, #2a160a, #f4c47a)" },
    { title:"Oppenheimer",      year:2023, runtime:"3h 00m", rating:8.4, qual:"1080p",     art:"linear-gradient(160deg, #0a0a0a, #d4a72c)" },
    { title:"Arrival",          year:2016, runtime:"1h 56m", rating:7.9, qual:"1080p",     art:"linear-gradient(135deg, #06121a, #5a9aa6)" },
    { title:"Blade Runner 2049",year:2017, runtime:"2h 44m", rating:8.0, qual:"4K HDR",    art:"linear-gradient(135deg, #2a0a14, #f4844a)" },
    { title:"Tenet",            year:2020, runtime:"2h 30m", rating:7.4, qual:"1080p",     art:"linear-gradient(135deg, #0a141a, #ea7322)" },
    { title:"The Prestige",     year:2006, runtime:"2h 10m", rating:8.5, qual:"1080p",     art:"linear-gradient(135deg, #0a0a0a, #6a4a2a)" },
    { title:"Sicario",          year:2015, runtime:"2h 01m", rating:7.6, qual:"1080p",     art:"linear-gradient(135deg, #1a0a08, #c4a07a)" },
    { title:"Heat",             year:1995, runtime:"2h 50m", rating:8.3, qual:"720p",      art:"linear-gradient(180deg, #1a1a1a, #4a6a8a)" },
    { title:"Drive",            year:2011, runtime:"1h 40m", rating:7.8, qual:"1080p",     art:"linear-gradient(135deg, #1a0820, #ec4899)" },
  ],

  shows: [
    { title:"Breaking Bad",        seasons:5, episodes:62, rating:9.5, qual:"1080p",  art:"linear-gradient(135deg, #1a3a1a, #4a8a4a)" },
    { title:"The Wire",            seasons:5, episodes:60, rating:9.3, qual:"720p",   art:"linear-gradient(135deg, #1a1a2a, #4a4a6a)" },
    { title:"Severance",           seasons:2, episodes:19, rating:8.7, qual:"4K HDR", art:"linear-gradient(135deg, #0a1a3a, #4a8aea)" },
    { title:"Andor",               seasons:1, episodes:12, rating:8.4, qual:"4K HDR", art:"linear-gradient(135deg, #2a1a0a, #ea8a4a)" },
    { title:"Better Call Saul",    seasons:6, episodes:63, rating:9.0, qual:"1080p",  art:"linear-gradient(135deg, #2a0a0a, #ea4a4a)" },
    { title:"True Detective",      seasons:4, episodes:32, rating:8.9, qual:"1080p",  art:"linear-gradient(135deg, #0a2a2a, #4aaaaa)" },
    { title:"Succession",          seasons:4, episodes:39, rating:8.9, qual:"4K HDR", art:"linear-gradient(135deg, #1a1a1a, #aaaaaa)" },
    { title:"Chernobyl",           seasons:1, episodes:5,  rating:9.4, qual:"1080p",  art:"linear-gradient(135deg, #2a2a1a, #cacaaa)" },
  ],
