...
│   ├── stream_session.py   # StreamStartResponse (+ resume_sec, applied_seek_sec, hdr_format, tonemapped fields), StreamSeekResponse{applied_seek_sec} (was 204; now surfaces segment-aligned seek for scrubber-offset bookkeeping — pipeline plan §16), StreamSessionResponse ✅
