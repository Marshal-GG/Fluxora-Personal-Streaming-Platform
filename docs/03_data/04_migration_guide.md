...
The full server test suite (637 tests as of 2026-05-07) must still pass. If a previously-passing test breaks, your migration changed something the rest of the code relied on.
