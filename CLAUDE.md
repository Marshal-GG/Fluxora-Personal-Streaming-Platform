...
| Android ExoPlayer migration — plan 24 (**Active 2026-05-15**; M1 Kotlin platform-channel spike + M2 `PlayerEngine` Dart abstraction + M3 `ExoPlayerEngine` Dart + M4 Kotlin module + M5-M8 multi-audio / HDR / lifecycle / seek + M9 tests + doc sweep; ~37 h ≈ 5 working days; rollback via `_kForceMediaKitOnAndroid` flag; iOS deferred; multi-rendition HLS server output split into plan 25) | `docs/10_planning/24_player_audio_reliability_plan.md` |
