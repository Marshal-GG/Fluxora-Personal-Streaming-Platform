...
| Library transcode follow-ups — plan 19 (M7 launch-priority: client-side decoding default + AV1/VP9 stream-copy + global Streaming-mode toggle in encoder settings; M1-M6 + M8 deferred to v1.1) | `docs/10_planning/19_library_transcode_followups.md` |
