...
mixin _$EncoderBenchmarkResult {
 ...
 String get encoder; String get vendor; String get codec; bool get passed; String? get error; double? get fps; double? get speedX; double? get bitrateKbps; int? get encodedFrames; double? get elapsedSec; double? get realtimeMultiplier; int? get initMs; double? get gpuUtilizationPercent; int? get vramUsedMb; int? get concurrentSessionCap; int? get recommendedConcurrent; int? get verifiedConcurrent;
...
@useResult
$Res call({
 String encoder, String vendor, String codec, bool passed, String? error, double? fps, double? speedX, double? bitrateKbps, int? encodedFrames, double? elapsedSec, double? realtimeMultiplier, int? initMs, double? gpuUtilizationPercent, int? vramUsedMb, int? concurrentSessionCap, int? recommendedConcurrent, int? verifiedConcurrent
});
...
/// Create a copy of EncoderBenchmarkResult
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? encoder = null,Object? vendor = null,Object? codec = null,Object? passed = null,Object? error = freezed,Object? fps = freezed,Object? speedX = freezed,Object? bitrateKbps = freezed,Object? encodedFrames = freezed,Object? elapsedSec = freezed,Object? realtimeMultiplier = freezed,Object? initMs = freezed,Object? gpuUtilizationPercent = freezed,Object? vramUsedMb = freezed,Object? concurrentSessionCap = freezed,Object? recommendedConcurrent = freezed,Object? verifiedConcurrent = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String encoder,  String vendor,  String codec,  bool passed,  String? error,  double? fps,  double? speedX,  double? bitrateKbps,  int? encodedFrames,  double? elapsedSec,  double? realtimeMultiplier,  int? initMs,  double? gpuUtilizationPercent,  int? vramUsedMb,  int? concurrentSessionCap,  int? recommendedConcurrent,  int? verifiedConcurrent)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EncoderBenchmarkResult() when $default != null:
return $default(_that.encoder,_that.vendor,_that.codec,_that.passed,_that.error,_that.fps,_that.speedX,_that.bitrateKbps,_that.encodedFrames,_that.elapsedSec,_that.realtimeMultiplier,_that.initMs,_that.gpuUtilizationPercent,_that.vramUsedMb,_that.concurrentSessionCap,_that.recommendedConcurrent,_that.verifiedConcurrent);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String encoder,  String vendor,  String codec,  bool passed,  String? error,  double? fps,  double? speedX,  double? bitrateKbps,  int? encodedFrames,  double? elapsedSec,  double? realtimeMultiplier,  int? initMs,  double? gpuUtilizationPercent,  int? vramUsedMb,  int? concurrentSessionCap,  int? recommendedConcurrent,  int? verifiedConcurrent)  $default,) {final _that = this;
switch (_that) {
case _EncoderBenchmarkResult():
return $default(_that.encoder,_that.vendor,_that.codec,_that.passed,_that.error,_that.fps,_that.speedX,_that.bitrateKbps,_that.encodedFrames,_that.elapsedSec,_that.realtimeMultiplier,_that.initMs,_that.gpuUtilizationPercent,_that.vramUsedMb,_that.concurrentSessionCap,_that.recommendedConcurrent,_that.verifiedConcurrent);case _:
  throw StateError('Unexpected subclass');
...
class _EncoderBenchmarkResult implements EncoderBenchmarkResult {
  const _EncoderBenchmarkResult({required this.encoder, required this.vendor, required this.codec, required this.passed, this.error, this.fps, this.speedX, this.bitrateKbps, this.encodedFrames, this.elapsedSec, this.realtimeMultiplier, this.initMs, this.gpuUtilizationPercent, this.vramUsedMb, this.concurrentSessionCap, this.recommendedConcurrent, this.verifiedConcurrent});
...
/// Create a copy of EncoderBenchmarkResult
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? encoder = null,Object? vendor = null,Object? codec = null,Object? passed = null,Object? error = freezed,Object? fps = freezed,Object? speedX = freezed,Object? bitrateKbps = freezed,Object? encodedFrames = freezed,Object? elapsedSec = freezed,Object? realtimeMultiplier = freezed,Object? initMs = freezed,Object? gpuUtilizationPercent = freezed,Object? vramUsedMb = freezed,Object? concurrentSessionCap = freezed,Object? recommendedConcurrent = freezed,Object? verifiedConcurrent = freezed,}) {
...
/// the history sidebar + to fetch / delete the run by id.
 int get id; String get startedAt; String get finishedAt; int get durationSec; int get fps; int get width; int get height; bool get verifyCaps; List<EncoderBenchmarkResult> get results;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startedAt,finishedAt,durationSec,fps,width,height,verifyCaps,const DeepCollectionEquality().hash(results));

@override
String toString() {
  return 'EncoderBenchmarkRun(id: $id, startedAt: $startedAt, finishedAt: $finishedAt, durationSec: $durationSec, fps: $fps, width: $width, height: $height, verifyCaps: $verifyCaps, results: $results)';
}
...
@useResult
$Res call({
 int id, String startedAt, String finishedAt, int durationSec, int fps, int width, int height, bool verifyCaps, List<EncoderBenchmarkResult> results
});
...
/// Create a copy of EncoderBenchmarkRun
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? startedAt = null,Object? finishedAt = null,Object? durationSec = null,Object? fps = null,Object? width = null,Object? height = null,Object? verifyCaps = null,Object? results = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String startedAt,  String finishedAt,  int durationSec,  int fps,  int width,  int height,  bool verifyCaps,  List<EncoderBenchmarkResult> results)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EncoderBenchmarkRun() when $default != null:
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.durationSec,_that.fps,_that.width,_that.height,_that.verifyCaps,_that.results);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String startedAt,  String finishedAt,  int durationSec,  int fps,  int width,  int height,  bool verifyCaps,  List<EncoderBenchmarkResult> results)  $default,) {final _that = this;
switch (_that) {
case _EncoderBenchmarkRun():
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.durationSec,_that.fps,_that.width,_that.height,_that.verifyCaps,_that.results);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String startedAt,  String finishedAt,  int durationSec,  int fps,  int width,  int height,  bool verifyCaps,  List<EncoderBenchmarkResult> results)?  $default,) {final _that = this;
switch (_that) {
case _EncoderBenchmarkRun() when $default != null:
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.durationSec,_that.fps,_that.width,_that.height,_that.verifyCaps,_that.results);case _:
  return null;
...
class _EncoderBenchmarkRun implements EncoderBenchmarkRun {
  const _EncoderBenchmarkRun({required this.id, required this.startedAt, required this.finishedAt, required this.durationSec, required this.fps, required this.width, required this.height, required this.verifyCaps, required final  List<EncoderBenchmarkResult> results}): _results = results;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startedAt,finishedAt,durationSec,fps,width,height,verifyCaps,const DeepCollectionEquality().hash(_results));
...
/// Create a copy of EncoderBenchmarkRun
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? startedAt = null,Object? finishedAt = null,Object? durationSec = null,Object? fps = null,Object? width = null,Object? height = null,Object? verifyCaps = null,Object? results = null,}) {
...
mixin _$BenchmarkHistoryEntry {
 ...
 int get id; String get startedAt; String get finishedAt; int get durationSec; int get fps; int get width; int get height; bool get verifyCaps; int get encoderCount;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BenchmarkHistoryEntry&&(identical(other.id, id) || other.id == id)&&(identical(other.startedAt, startedAt) || other.startedAt == startedAt)&&(identical(other.finishedAt, finishedAt) || other.finishedAt == finishedAt)&&(identical(other.durationSec, durationSec) || other.durationSec == durationSec)&&(identical(other.fps, fps) || other.fps == fps)&&(identical(other.width, width) || other.width == width)&&(identical(other.height, height) || other.height == height)&&(identical(other.verifyCaps, verifyCaps) || other.verifyCaps == verifyCaps)&&(identical(other.encoderCount, encoderCount) || other.encoderCount == encoderCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,startedAt,finishedAt,durationSec,fps,width,height,verifyCaps,encoderCount);

@override
String toString() {
  return 'BenchmarkHistoryEntry(id: $id, startedAt: $startedAt, finishedAt: $finishedAt, durationSec: $durationSec, fps: $fps, width: $width, height: $height, verifyCaps: $verifyCaps, encoderCount: $encoderCount)';
}
...
@useResult
$Res call({
 int id, String startedAt, String finishedAt, int durationSec, int fps, int width, int height, bool verifyCaps, int encoderCount
});
...
/// Create a copy of BenchmarkHistoryEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? startedAt = null,Object? finishedAt = null,Object? durationSec = null,Object? fps = null,Object? width = null,Object? height = null,Object? verifyCaps = null,Object? encoderCount = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,startedAt: null == startedAt ? _self.startedAt : startedAt // ignore: cast_nullable_to_non_nullable
as String,finishedAt: null == finishedAt ? _self.finishedAt : finishedAt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String startedAt,  String finishedAt,  int durationSec,  int fps,  int width,  int height,  bool verifyCaps,  int encoderCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BenchmarkHistoryEntry() when $default != null:
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.durationSec,_that.fps,_that.width,_that.height,_that.verifyCaps,_that.encoderCount);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String startedAt,  String finishedAt,  int durationSec,  int fps,  int width,  int height,  bool verifyCaps,  int encoderCount)  $default,) {final _that = this;
switch (_that) {
case _BenchmarkHistoryEntry():
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.durationSec,_that.fps,_that.width,_that.height,_that.verifyCaps,_that.encoderCount);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String startedAt,  String finishedAt,  int durationSec,  int fps,  int width,  int height,  bool verifyCaps,  int encoderCount)?  $default,) {final _that = this;
switch (_that) {
case _BenchmarkHistoryEntry() when $default != null:
return $default(_that.id,_that.startedAt,_that.finishedAt,_that.durationSec,_that.fps,_that.width,_that.height,_that.verifyCaps,_that.encoderCount);case _:
  return null;
...
class _BenchmarkHistoryEntry implements BenchmarkHistoryEntry {
  const _BenchmarkHistoryEntry({required this.id, required this.startedAt, required this.finishedAt, required this.durationSec, required this.fps, required this.width, required this.height, required this.verifyCaps, required this.encoderCount});
...
/// Create a copy of BenchmarkHistoryEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? startedAt = null,Object? finishedAt = null,Object? durationSec = null,Object? fps = null,Object? width = null,Object? height = null,Object? verifyCaps = null,Object? encoderCount = null,}) {
...
mixin _$BenchmarkProgress {
 ...
 bool get running; String? get startedAt; int? get totalEncoders; int? get completed; String? get currentEncoder; String? get currentStep; int? get currentIndex;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,running,startedAt,totalEncoders,completed,currentEncoder,currentStep,currentIndex);

@override
String toString() {
  return 'BenchmarkProgress(running: $running, startedAt: $startedAt, totalEncoders: $totalEncoders, completed: $completed, currentEncoder: $currentEncoder, currentStep: $currentStep, currentIndex: $currentIndex)';
}
...
@useResult
$Res call({
 bool running, String? startedAt, int? totalEncoders, int? completed, String? currentEncoder, String? currentStep, int? currentIndex
});
...
/// Create a copy of BenchmarkProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? running = null,Object? startedAt = freezed,Object? totalEncoders = freezed,Object? completed = freezed,Object? currentEncoder = freezed,Object? currentStep = freezed,Object? currentIndex = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool running,  String? startedAt,  int? totalEncoders,  int? completed,  String? currentEncoder,  String? currentStep,  int? currentIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BenchmarkProgress() when $default != null:
return $default(_that.running,_that.startedAt,_that.totalEncoders,_that.completed,_that.currentEncoder,_that.currentStep,_that.currentIndex);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool running,  String? startedAt,  int? totalEncoders,  int? completed,  String? currentEncoder,  String? currentStep,  int? currentIndex)  $default,) {final _that = this;
switch (_that) {
case _BenchmarkProgress():
return $default(_that.running,_that.startedAt,_that.totalEncoders,_that.completed,_that.currentEncoder,_that.currentStep,_that.currentIndex);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool running,  String? startedAt,  int? totalEncoders,  int? completed,  String? currentEncoder,  String? currentStep,  int? currentIndex)?  $default,) {final _that = this;
switch (_that) {
case _BenchmarkProgress() when $default != null:
return $default(_that.running,_that.startedAt,_that.totalEncoders,_that.completed,_that.currentEncoder,_that.currentStep,_that.currentIndex);case _:
  return null;
...
class _BenchmarkProgress implements BenchmarkProgress {
  const _BenchmarkProgress({required this.running, this.startedAt, this.totalEncoders, this.completed, this.currentEncoder, this.currentStep, this.currentIndex});
...
/// Create a copy of BenchmarkProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? running = null,Object? startedAt = freezed,Object? totalEncoders = freezed,Object? completed = freezed,Object? currentEncoder = freezed,Object? currentStep = freezed,Object? currentIndex = freezed,}) {
