...
///
/// Pixel-matches the prototype `Button` component (desktop primitives.jsx
/// lines 42–64, mobile primitives `FluxButton`). Six visual variants
/// ([FluxButtonVariant]) and three sizes ([FluxButtonSize]). Hover state is
/// animated over 150 ms; the cursor switches to a pointer when enabled. No
/// Material ripple is used.
library;
...
class _FluxButtonState extends State<FluxButton> {
  ...
  Color? get _bgColor => switch (widget.variant) {
        ...
        FluxButtonVariant.secondary => const Color(0x0AFFFFFF),
  ...
  Color? get _borderColor => switch (widget.variant) {
        ...
        FluxButtonVariant.secondary => const Color(0x14FFFFFF),
        FluxButtonVariant.ghost => Colors.transparent,
        FluxButtonVariant.outline => AppColors.borderHover,
        FluxButtonVariant.danger => const Color(0x4DEF4444),
        FluxButtonVariant.success => const Color(0x4D10B981),
      };
