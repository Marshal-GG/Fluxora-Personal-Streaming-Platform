...
// ExoPlayerPlugin is registered via FlutterEngine.plugins.add(...) so its
// onAttachedToEngine/onDetachedFromEngine callbacks fire on the standard
// FlutterPlugin lifecycle.  No manual MethodChannel wiring or onDestroy
...
class MainActivity : FlutterFragmentActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        // No Activity-level teardown needed; the engine releases the
        // plugin when it tears down.
